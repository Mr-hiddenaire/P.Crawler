...
class ContentService:
    ...
    def get_total_torrent_not_download(types=None, is_scraped=None):
        total = Contents.get_total_torrent_not_download(types=types, is_scraped=is_scraped)
        return total
    ...
    def get_content_torrent_not_download(offset=None, page_size=None, types=None, is_scraped=None):
        list_result = Contents.get_content_torrent_not_download(offset=offset, page_size=page_size, types=types, is_scraped=is_scraped)
        return list_result